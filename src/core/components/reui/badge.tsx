...
const badgeVariants = cva(
  "focus-visible:ring-ring focus-visible:ring-offset-background relative inline-flex w-fit shrink-0 items-center justify-center border border-transparent font-medium whitespace-nowrap transition-shadow outline-none focus-visible:ring-2 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*=size-])]:size-3",
  {
    variants: {
      variant: {
        ...
        "primary-light": "bg-primary/10 text-primary dark:bg-primary/20 border-none",
        "warning-light": "bg-warning/10 text-warning-foreground dark:bg-warning/20 border-none",
        "success-light": "bg-success/10 text-success-foreground dark:bg-success/20 border-none",
        "info-light": "bg-info/10 text-info-foreground dark:bg-info/20 border-none",
        "destructive-light":
          "bg-destructive/10 text-destructive-foreground dark:bg-destructive/20 border-none",
        "invert-light": "bg-invert/10 text-foreground dark:bg-invert/20 border-none",
        "focus-light": "bg-focus/10 text-focus-foreground dark:bg-focus/20 border-none",
